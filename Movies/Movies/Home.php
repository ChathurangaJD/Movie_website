...
<html>
	...
	#movie4:hover .circle6{
		height:190px;
		width:190px;
	}
	#movie4:hover .circle6 h3{
		transition:all 0.5s;
		transition-delay:.2s;
		top:40%;
		left:25%;
    ...
    <body>
        ...
        <div id="slider">
            <div>
                <img src="poster/wp11157463-vikram-movie-kamal-haasan-wallpapers.jpg" height="150%" width="20%"/>
                <img src="poster/HateStory_.jpg" height="100%" width="100%"/>
                <img src="poster/Slasher.jpg" height="100%" width="100%"/>
                <img src="poster/wp13123305-prey-movie-wallpapers.jpg" height="100%" width="100%"/>
                <img src="poster/desktop-wallpaper celpox-maha-samudram.jpg" height="100%" width="100%"/>
	...
	<div id="topm">
		<table border="0" cellspacing="50px" align="center">
			...
			<tr>
                <?php
                    $query2="select * from home_page_top_movie where id=5";
                ...
                ?>
         <?php
                    $query2="select * from home_page_top_movie where id=6";
...
NOW AVAILABEL
				...
				<Tr>
					...
					<td>
						<div id="box">
							<div class="poster">
								<img src="poster/<?php echo $data['poster']; ?>" height="152px" width="300px"/>
							</div>
				...
				<Tr>
					...
					<td>
						<div id="box">
							<div class="poster">
								<img src="poster/<?php echo $data['poster']; ?>" height="155px" width="300px"/>
							</div>
							<div class="postername">
								<table border="0" cellspacing="10px" width="300px">
									<tr>
